...
1. Open `outputs/runs/seed-cover-prismatic-glass-object/contact-sheet.jpg`.
2. Read `outputs/runs/seed-cover-prismatic-glass-object/source-review.json`.
...
5. Read `outputs/runs/seed-cover-prismatic-glass-object/prompt.txt`.
6. Generate candidate assets using the prompt.
7. Save generated chroma-key images in `outputs/runs/seed-cover-prismatic-glass-object/generated`.
...
python3 scripts/chroma_to_alpha.py \
  --input outputs/runs/seed-cover-prismatic-glass-object/generated/<candidate>.png \
  --output outputs/runs/seed-cover-prismatic-glass-object/cutouts/<candidate>-alpha.png \
  --key ff00ff
```
...
python3 scripts/build_contact_sheet.py \
  --input-dir outputs/runs/seed-cover-prismatic-glass-object/cutouts \
  --output outputs/runs/seed-cover-prismatic-glass-object/comparison.jpg \
  --columns 4 \
  --labels
```

Then update `outputs/runs/seed-cover-prismatic-glass-object/taste-notes.md` with:
