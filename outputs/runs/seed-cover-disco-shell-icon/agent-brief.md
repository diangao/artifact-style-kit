...
1. Open `outputs/runs/seed-cover-disco-shell-icon/contact-sheet.jpg`.
2. Read `outputs/runs/seed-cover-disco-shell-icon/source-review.json`.
...
5. Read `outputs/runs/seed-cover-disco-shell-icon/prompt.txt`.
6. Generate candidate assets using the prompt.
7. Save generated chroma-key images in `outputs/runs/seed-cover-disco-shell-icon/generated`.
...
python3 scripts/chroma_to_alpha.py \
  --input outputs/runs/seed-cover-disco-shell-icon/generated/<candidate>.png \
  --output outputs/runs/seed-cover-disco-shell-icon/cutouts/<candidate>-alpha.png \
  --key ff00ff
```
...
python3 scripts/build_contact_sheet.py \
  --input-dir outputs/runs/seed-cover-disco-shell-icon/cutouts \
  --output outputs/runs/seed-cover-disco-shell-icon/comparison.jpg \
  --columns 4 \
  --labels
```

Then update `outputs/runs/seed-cover-disco-shell-icon/taste-notes.md` with:
